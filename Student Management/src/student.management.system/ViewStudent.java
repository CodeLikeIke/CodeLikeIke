...
import student.management.system.UpdateStudent;
...
public class ViewStudent extends JFrame implements ActionListener{
    ...
    ViewEmployee() {
        ...
        try {
            ...
            while(rs.next()) {
                cstudentId.add(rs.getString("empId"));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == search) {
            String query = "select * from student where empId = '"+cstudentId.getSelectedItem()+"'";
            try {
                Conn c = new Conn();
